...
class Testy(unittest.TestCase):
    def test_lendBook(self):
        ...
        self.assertEqual(library.availableBooks, ["Naocznosc", "Sens Sztuki"])
    ...
    def test_addBook(self):
        library = Library(["Naocznosc", "Sens Sztuki"])
        LenLibraryBooks = len(library.availableBooks)
        self.assertEqual(library.availableBooks, ["Naocznosc", "Sens Sztuki"])
        library.addBook("Kobziarz")
        self.assertEqual(len(library.availableBooks), LenLibraryBooks+1)
        self.assertTrue("Kobziarz" in library.availableBooks)
